...
def validar_personal(usuario, contraseña, intentos):
...
def registrar_personal(usuario, contraseña):
    ...
    try: 
        ...
        match op:
            case 1:
                ...
                validar_personal(usuario, contraseña, intentos)
        
            case 2:
                usuario=input("Ingrese el nombre de usuario:")
                contraseña=input("Ingrese la contraseña del usuario:")
                registrar_personal(usuario, contraseña)                
